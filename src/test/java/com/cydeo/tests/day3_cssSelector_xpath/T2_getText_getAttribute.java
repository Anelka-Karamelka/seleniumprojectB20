...
//        3- Verify “remember me” label text is as expected:
        ...
        String expectedRememberMeLabel="Remember me on the computer";
...
//        Expected: Forgot your password?
        ...
        if(actualForgotPasswordLink.equals(expectedForgotPasswordLink)){
            System.out.println("Forgot password link  is passed");
        }else{
            ...
            System.out.println("Forgot password link  is failed");
        }
